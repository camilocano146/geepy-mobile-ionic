...
@Component({
  ...
  templateUrl: './sim-modal-e-sims-instructions-android.component.html',
  styleUrls: ['./sim-modal-e-sims-instructions-android.component.scss'],
})
export class SimModalESimsInstructionsAndroidComponent implements OnInit {
  // Lenguaje
